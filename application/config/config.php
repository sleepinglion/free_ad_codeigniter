...
|
*/
$config['base_url'] = 'http://localhost:20001';
...
$config['uploads_directory']=FCPATH . 'uploads';
...
//if S3
//$config['s3']=TRUE;
//$config['bucket']='slhome';
//$config['uploads_url']='https://s3-ap-northeast-1.amazonaws.com/slhome';
