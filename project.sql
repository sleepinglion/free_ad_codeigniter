...
INSERT INTO `community_categories` VALUES (1,'픽공유',1,'2015-03-25 13:26:01'),(2,'라인업 / 직관',1,'2015-03-25 13:26:01'),(3,'자유',1,'2015-03-25 13:28:18'),(4,'유머',1,'2015-03-25 13:28:18'),(5,'포토',1,'2015-03-25 13:28:41'),(6,'감동',1,'2015-03-25 13:28:41');
/*!40000 ALTER TABLE `community_categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `community_comment_comments`
--

DROP TABLE IF EXISTS `community_comment_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `community_comment_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `community_comment_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `board_id` (`community_comment_id`),
  KEY `poll_id` (`poll_id`),
  CONSTRAINT `community_comment_comments_ibfk_1` FOREIGN KEY (`community_comment_id`) REFERENCES `community_comments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `community_comment_comments`
--

LOCK TABLES `community_comment_comments` WRITE;
/*!40000 ALTER TABLE `community_comment_comments` DISABLE KEYS */;
INSERT INTO `community_comment_comments` VALUES (1,3,4,32,'2346234623462347','2015-06-19 14:40:41'),(2,2,5,32,'234623463246','2015-06-19 14:40:48'),(3,2,5,32,'2346246236','2015-06-19 14:40:56');
/*!40000 ALTER TABLE `community_comment_comments` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `community_comments` (
  ...
  KEY `user_id` (`user_id`),
  KEY `poll_id` (`poll_id`),
  KEY `poll_community_id` (`community_id`),
  CONSTRAINT `community_comments_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `community_comments_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `community_comments_ibfk_3` FOREIGN KEY (`poll_id`) REFERENCES `polls` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `community_comments` VALUES (1,2,5,32,'1235123523',0,'2015-06-19 13:39:25'),(2,2,5,32,'23463246',0,'2015-06-19 14:00:10'),(3,2,6,32,'12351235',0,'2015-06-19 14:00:14'),(4,12,27,32,'12351236',0,'2015-06-22 15:00:02'),(5,12,28,32,'12351236',0,'2015-06-22 15:00:11'),(6,9,21,32,'3462347',0,'2015-06-22 15:58:56');
...
CREATE TABLE `community_contents` (
  ...
  `content` text COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `community_contents_ibfk_1` FOREIGN KEY (`id`) REFERENCES `communities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `community_photos` (
  ...
  CONSTRAINT `community_photos_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `community_recommend_logs` (
  ...
  KEY `user_id` (`user_id`),
  KEY `poll_community_id` (`community_id`) USING BTREE,
  CONSTRAINT `community_recommend_logs_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `community_recommend_logs`
--

LOCK TABLES `community_recommend_logs` WRITE;
/*!40000 ALTER TABLE `community_recommend_logs` DISABLE KEYS */;
INSERT INTO `community_recommend_logs` VALUES (1,19,32,0,'2015-07-21 11:30:52'),(2,20,32,0,'2015-07-21 12:09:25');
/*!40000 ALTER TABLE `community_recommend_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `polls` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `poll_unique` (`community_id`,`title`),
  KEY `user_id` (`community_id`),
  KEY `poll_community_id` (`community_id`),
  CONSTRAINT `polls_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
